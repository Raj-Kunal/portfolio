...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-20 shadow-xl z-[100]' style={{ backgroundColor: `${navBg}` }}>
      <div className="flex justify-between items-center w-full h-full px-4 2xl:px-16">
        <Link href={'/'} passHref>
        <Image  src="/../public/assets/logo.png" alt="" width="90" height='60'/>
        </Link>
        <div>
             ...
             'fixed left-[-100%] top-0 p-10 ease-in duration-500'}>
                <div>
                    <div className='flex w-full items-center justify-between'>
                        <Link href={'/'} passHref>
                        <Image src="/../public/assets/logo.png" width="60" height="35" alt="/"  onClick={()=>setNav(false)}/>
                        </Link>
                        <div className='rounded-full p-3 shadow-lg shadow-gray-500 cursor-pointer' onClick={handleNav}>
                ...
                <div className='py-4 flex flex-col'>
                    ...
                    <div className="pt-32">
                        <p className='uppercase font-bold tracking-widest text-[#5651e5]'>Lets's Connect</p>
                    ...
                    rel='noreferrer'>
                      <div onClick={()=>setNav(false)} className="rounded-full shadow-lg shadow-gray-500 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
                        <FaLinkedinIn />
                      </div>
                    </a>
